// 02. Texture.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "framework.h"
#include "03. Terrain.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY03TERRAIN, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY03TERRAIN));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY03TERRAIN));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_ACTIVATE:
        g_framework->SetActive(static_cast<BOOL>(wParam));
        break;
    case WM_SIZE:
        break;
    case WM_LBUTTONDOWN:
